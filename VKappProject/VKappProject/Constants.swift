...
enum Constants {
    ...
    enum Identifiers {
        ...
        static let newsTextCellIdentifier = "NewsTextCell"
    ...
    enum URLComponents {
        ...
        static let newsFilterPosts = "&filters=post"
        static let friendPhotoMethod = "photos.getAll?"
        static let getNewsMethod = "newsfeed.get?"
    ...
    enum WebViewURLComponents {
        ...
        static let clientIdValue = "51496531"
